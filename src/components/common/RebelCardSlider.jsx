        ...
        <div className="w-full mt-8 lg:px-6 flex flex-wrap lg:flex-wrap gap-6 lg:gap-6 items-center pb-10 lg:pb-10 justify-center">
          {bottle.map((item, index) => {
            return (
              <div
                key={index}
                className="w-[285px] h-[400px] flex justify-center items-start flex-col border-2 border-solid border-neutral-700 border-t-8 rounded-md p-3 group hover:bg-supernova duration-300 cursor-pointer"
              >
